...
/*
 * It adds a new redirection to the list of redirections,
 * and removes the two tokens that make up the
 * redirection from the lexer list
*/
...
* from the lexer list and adds them to the redirection list
*/
