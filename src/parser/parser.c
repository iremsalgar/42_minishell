...
* removes the redirections from it, and returns a simple command
*/
...
/*
* The parser function counts the pipes,
* makes the control of first parametre is pipe or not
* It parses the lexer list and creates a simple_cmds list
*/
