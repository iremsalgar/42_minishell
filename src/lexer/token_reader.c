...
/*token_reader function tokenizes pipe, redirection and heredoc
this funciton does not tokenize the in-quote special characters
after all the function adds the tokens to the lexer_list*/
