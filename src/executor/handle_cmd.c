...
/*It forks, and if it's the child, it calls
handle_cmd, which will execute the command. If it's the
parent, it waits for the child to finish,
and then sets the global error number to the exit status
of the child*/
